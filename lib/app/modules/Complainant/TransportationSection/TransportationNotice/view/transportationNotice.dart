...
import '../../../../../models/noticeData.dart';
import '../controller/transportationNoticeController.dart';
...
class TransportationNotice extends GetView<TransportationNoticeController> {
    static const route = '/transportation-notice';
  static launch() => Get.toNamed(route);
  const TransportationNotice({Key? key}) : super(key: key);
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.hasData) {
                        ...
                        for (var message in notice) {
                          ...
                          notices.add(NoticeDataModel(subjects, body));
                        }
                      }
